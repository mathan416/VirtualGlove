...
REQUIRED_FILES = {
    ...
    "VirtualGlove/hardware/enclosures/enclosure-files.json",
    "VirtualGlove/hardware/enclosures/bundles/VirtualGlove-UNO-Q-Case-Print-Files.zip",
    "VirtualGlove/hardware/enclosures/bundles/VirtualGlove-Controller-Dock-V1-Print-Files.zip",
    "VirtualGlove/hardware/enclosures/bundles/VirtualGlove-Controller-Dock-V2.1-Print-Files.zip",
    ...
    "VirtualGlove/hardware/enclosures/previews/virtualglove-controller-dock-v2-1-exterior.png",
    "VirtualGlove/hardware/enclosures/previews/virtualglove-controller-dock-v2-1-back.png",
    "VirtualGlove/hardware/enclosures/previews/virtualglove-controller-dock-v2-1-left.png",
    "VirtualGlove/hardware/enclosures/previews/virtualglove-controller-dock-v2-1-right.png",
    "VirtualGlove/hardware/enclosures/previews/virtualglove-controller-dock-v2-1-exploded.png",
    "VirtualGlove/hardware/enclosures/previews/virtualglove-controller-dock-v2-1-port-access.png",
    ...
    "VirtualGlove/hardware/enclosures/previews/virtualglove-enclosure-quick-reference-dock-v2-1.png",
    "VirtualGlove/hardware/enclosures/previews/virtualglove-enclosure-quick-reference-dock-v2-1-finish.png",
    ...
    "VirtualGlove/hardware/enclosures/stl/virtualglove-dock-v2-1-base.stl",
    "VirtualGlove/hardware/enclosures/stl/virtualglove-dock-v2-1-lid.stl",
    "VirtualGlove/hardware/enclosures/stl/virtualglove-dock-v2-1-lid-full-logo.stl",
    "VirtualGlove/hardware/enclosures/stl/virtualglove-dock-v2-1-mount-fit-coupon.stl",
    "VirtualGlove/hardware/enclosures/stl/virtualglove-dock-v2-1-wordmark-fit-coupon.stl",
    ...
    "VirtualGlove/hardware/enclosures/stl/virtualglove-uno-wordmark-backing.stl",
    "VirtualGlove/hardware/enclosures/stl/virtualglove-uno-wordmark-cyan.stl",
    "VirtualGlove/hardware/enclosures/stl/virtualglove-uno-wordmark-red.stl",
    "VirtualGlove/hardware/enclosures/stl/virtualglove-uno-wordmark-multicolor.3mf",
    ...
    "VirtualGlove/scripts/verify-retropie-native-core.py",
    "VirtualGlove/scripts/configure-super-glove-ball-core.py",
    "VirtualGlove/native/retropie/manifest.json",
    "VirtualGlove/native/retropie/armv6/nestopia_powerglove_libretro.so",
    "VirtualGlove/native/retropie/armv6/nestopia-powerglove-source.tar.gz",
    "VirtualGlove/native/retropie/armv7/nestopia_powerglove_libretro.so",
    "VirtualGlove/native/retropie/armv7/nestopia-powerglove-source.tar.gz",
    "VirtualGlove/native/retropie/armv8_32/nestopia_powerglove_libretro.so",
    "VirtualGlove/native/retropie/armv8_32/nestopia-powerglove-source.tar.gz",
    "VirtualGlove/native/retropie/aarch64/nestopia_powerglove_libretro.so",
    "VirtualGlove/native/retropie/aarch64/nestopia-powerglove-source.tar.gz",
    "VirtualGlove/native/retropie/x86_64/nestopia_powerglove_libretro.so",
    "VirtualGlove/native/retropie/x86_64/nestopia-powerglove-source.tar.gz",
    ...
    "VirtualGlove/retropie/arcade-cabinet-merger/README.txt",
    "VirtualGlove/retropie/arcade-cabinet-merger/arcade-gamepad-merger",
    "VirtualGlove/retropie/arcade-cabinet-merger/arcade-gamepad-merger.service",
    "VirtualGlove/retropie/arcade-cabinet-merger/propose-controller-router.py",
    "VirtualGlove/retropie/arcade-cabinet-merger/retroarch/Arcade Merged Player 1.cfg",
    "VirtualGlove/retropie/arcade-cabinet-merger/retroarch/Arcade Merged Player 2.cfg",
    "VirtualGlove/src/virtualglove/console_monitor.py",
    "VirtualGlove/src/virtualglove/merged_gamepad.py",
    "VirtualGlove/src/virtualglove/controller_router.py",
    "VirtualGlove/src/virtualglove/controller_router_web.py",
