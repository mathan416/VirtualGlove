...
REQUIRED_FILES = {
    ...
    "VirtualGlove/src/powerglove_vision/merged_gamepad.py",
    ...
    "VirtualGlove/src/powerglove_vision/retroarch_remote.py",
    "VirtualGlove/src/powerglove_vision/launchbox_hook.py",
    "VirtualGlove/src/powerglove_vision/retroarch_hotkeys.py",
