...
p = argparse.ArgumentParser(description="Install VirtualGlove on retropie. Run as your normal login user.")
...
try:
    ...
    with tempfile.TemporaryDirectory(prefix="virtualglove-download-") as temporary:
        ...
        cmd = ["sudo", "python3", str(directory / "install-package.py"), "retropie",
