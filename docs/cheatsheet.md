...
The unversioned download commands select the current stable release, v0.5.1.
...
preserved by the supported in-place upgrade from VirtualGlove 0.4.2 to 0.5.1.
