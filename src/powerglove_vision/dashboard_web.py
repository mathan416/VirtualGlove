...
const programDetails={
 ...
 program_14:{title:'Program 14 — Manual controls',purpose:'Camera gestures are completely paused.',summary:'Use a conventional controller for all input while VirtualGlove retains the selected game profile.',mappings:[['Conventional controller','All controls']]},
