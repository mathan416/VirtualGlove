...
<p>Choose which configured joypads share each NES joystick player. Your original controllers keep working in the console menus; the merged players become active for supported FCEUmm and stock Nestopia gameplay.</p>
...
<p id=router-hotkey-warning class=router-hotkey-warning role=alert hidden>No physical controller is assigned to Player 1. RetroArch menu and exit hotkeys may be unavailable during NES joystick gameplay. Keep a keyboard available or assign a physical controller to Player 1.</p>
