...
HELP_GUIDES = (
    ...
    {'slug': 'enclosure', 'title': 'VirtualGlove Controller Enclosure Guide', 'file': 'ENCLOSURE_GUIDE.md', 'description': 'Print and assemble the compact UNO Q Case, low-profile Dock V1, or enclosed Dock V2.1.', 'group': 'Installation guides'},
    {'slug': 'enclosure-quick-reference', 'title': 'VirtualGlove Enclosure Assembly Quick Reference', 'file': 'ENCLOSURE_QUICK_REFERENCE.md', 'description': 'Pictographic workbench instructions for every maintained enclosure.', 'group': 'Installation guides'},
    ...
    {'slug': 'engineering-toolkit', 'title': 'Engineering Toolkit', 'file': 'ENGINEERING_TOOLKIT.md', 'description': 'Use version-matched camera, latency, routing, trace, replay, and native-research diagnostics.', 'group': 'Technical documentation'},
