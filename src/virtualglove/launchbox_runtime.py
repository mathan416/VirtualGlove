...
# File: src/virtualglove/launchbox_runtime.py
...
def ensure_background(settings_path: Path) -> None:
    ...
    subprocess.Popen(
        [str(executable), "-m", "virtualglove.launchbox_runtime", "run",
